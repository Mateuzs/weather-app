...
const WeatherStationInputForm: FunctionComponent<WeatherStationInputFormProps> =
  ({ onCloseHandler, weatherStationList }) => {
    ...
    const [isValidStationLatitude, setIsValidStationLatitude] =
      useState<boolean>(true);
    const [isValidStationLongitude, setIsValidStationLongitude] =
      useState<boolean>(true);
    const [isValidStationAltitude, setIsValidStationAltitude] =
      useState<boolean>(true);
    ...
    const saveButtonClassName = eligibleToSave
      ? "save-button"
      : "save-button-disabled";

    useEffect(() => {
      setIsValidStationName(
        validateStationName(stationName, weatherStationList)
      );
    }, [stationName]);
